...
def get_note_url(note_symbol):
    ...
    :param note_symbol: Symbol of the note, for example: CMT 00001
    :return: URL
    """
...
__KNOWN_LOGGERS = [
    KnownLoggerType(name='cmt.wallet_dlg', external=False),
    KnownLoggerType(name='cmt.bip44_wallet', external=False),
    KnownLoggerType(name='cmt.crownd_intf', external=False),
    KnownLoggerType(name='cmt.db_intf', external=False),
    KnownLoggerType(name='cmt.proposals', external=False),
    KnownLoggerType(name='cmt.ext_item_model', external=False),
    KnownLoggerType(name='cmt.hw_intf_trezor', external=False),
    KnownLoggerType(name='cmt.reg_masternode', external=False),
    KnownLoggerType(name='cmt.transaction_dlg', external=False),
    KnownLoggerType(name='cmt.app_cache', external=False),
