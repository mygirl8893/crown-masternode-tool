...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.edtMnCollateralAddress.setToolTip(_translate("MainWindow", "Crown address of the 5000 TRC collateral, coverted from BIP32 path with hardware wallet."))
        self.edtMnCollateralAddress.setPlaceholderText(_translate("MainWindow", "Crown address"))
        self.btnHwAddressToBip32.setToolTip(_translate("MainWindow", "Convert Crown address to BIP32 path using hardware wallet"))
        self.btnHwBip32ToAddress.setToolTip(_translate("MainWindow", "Convert BIP32 path to Crown address using hardware wallet"))
