...
class UpdMnRegistrarDlg(QDialog, ui_upd_mn_registrar_dlg.Ui_UpdMnRegistrarDlg, WndUtils):
    ...
    def update_ctrls_state(self):
        ...
        self.edtPayoutAddress.setToolTip('Enter a new payout Crown address.')
        ...
        if self.dmn_voting_key_type == InputKeyType.PRIVATE:
            ...
            key_type, tooltip_anchor, placeholder_text = ('address', 'privkey', 'Enter a new voting Crown address.')
            style = 'hl1'
        ...
        self.lblMessage.setText('<span style="color:#ff6600">By clicking <span style="font-weight:800">&lt;Send '
                                ...
                                'read notes <a href="https://github.com/Bertrand256/crown-masternode-tool/blob/'
    ...
    def validate_data(self):
        ...
        if key:
            if self.dmn_voting_key_type == InputKeyType.PRIVATE:
                ...
                if not validate_wif_privkey(self.dmn_new_voting_privkey, self.app_config.crown_network):
                ...
                self.dmn_new_voting_privkey = ''
                if not validate_address(self.dmn_new_voting_address, self.app_config.crown_network):
                    self.edtVotingKey.setFocus()
                    raise Exception('Invalid voting Crown address.')
        else:
    ...
    def update_manual_cmd_info(self):
        try:
            ...
            if changed:
                ...
                msg += "<li>Import the owner private key into the Crown Core wallet if you haven't done this " \
                       "before (<a href=\"https://github.com/Bertrand256/crown-masternode-tool/blob/master/doc/" \
    ...
    def on_btnSendUpdateTx_clicked(self, enabled):
        ...
        if self.dmn_prev_payout_address == self.dmn_new_payout_address and \
            ...
            WndUtils.warnMsg('Nothing is changed compared to the data stored in the Crown network.')
        else:
            self.send_upd_tx()
    ...
    def send_upd_tx(self):
        ...
        try:
            ...
            try:
                upd_reg_support = self.crownd_intf.checkfeaturesupport('protx_update_registrar',
