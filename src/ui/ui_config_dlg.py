...
class Ui_ConfigDlg(object):
    def setupUi(self, ConfigDlg):
        ...
        self.tabCrownd = QtWidgets.QWidget()
        self.tabCrownd.setObjectName("tabCrownd")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.tabCrownd)
        self.verticalLayout_3.setContentsMargins(3, 3, 3, 3)
        self.verticalLayout_3.setSpacing(3)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.label_2 = QtWidgets.QLabel(self.tabCrownd)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_3.addWidget(self.label_2)
        self.cboCrownNetwork = QtWidgets.QComboBox(self.tabCrownd)
        self.cboCrownNetwork.setObjectName("cboCrownNetwork")
        self.cboCrownNetwork.addItem("")
        self.cboCrownNetwork.addItem("")
        self.horizontalLayout_3.addWidget(self.cboCrownNetwork)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.verticalLayout_3.addLayout(self.horizontalLayout_3)
        self.frame_2 = QtWidgets.QFrame(self.tabCrownd)
        ...
        self.tabWidget.addTab(self.tabCrownd, "")
    ...
    def retranslateUi(self, ConfigDlg):
        ...
        self.label_2.setText(_translate("ConfigDlg", "Crown network:"))
        self.cboCrownNetwork.setItemText(0, _translate("ConfigDlg", "MAINNET"))
        self.cboCrownNetwork.setItemText(1, _translate("ConfigDlg", "TESTNET"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabCrownd), _translate("ConfigDlg", "Crown network"))
        ...
        self.chbDownloadProposalExternalData.setText(_translate("ConfigDlg", "Download external proposal attributes (CrownCentral.org)"))
