...
class Ui_ConfigDlg(object):
    def setupUi(self, ConfigDlg):
        ...
        self.splitter = QtWidgets.QSplitter(self.tabCrownd)
        ...
        self.chbRandomConn = QtWidgets.QCheckBox(self.tabCrownd)
        ...
        self.lblStatus.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextSelectableByMouse)
    ...
    def retranslateUi(self, ConfigDlg):
        ...
        self.chbDownloadProposalExternalData.setText(_translate("ConfigDlg", "Download external proposal attributes (services.crownplatform.com)"))
